    ...
    <div class="article_content">
      <div class="article-text">
        ...
        <div class="metabox"> 
          ...
          <span class="entry-comments"><i class="fas fa-comments"></i><?php comments_number( __('0 Comments','mobler-ecommerce'), __('0 Comments','mobler-ecommerce'), __('% Comments','mobler-ecommerce') ); ?></span>
        </div>
