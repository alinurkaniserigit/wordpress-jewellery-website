...
class Mobler_Ecommerce_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function mobler_ecommerce_loadClassLoader($class)
    {
    ...
    public static function mobler_ecommerce_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
