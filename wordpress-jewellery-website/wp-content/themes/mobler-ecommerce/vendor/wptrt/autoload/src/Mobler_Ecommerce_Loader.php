...
class Mobler_Ecommerce_Loader {
	 ...
	 * @return void
	 */
	public function mobler_ecommerce_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function mobler_ecommerce_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function mobler_ecommerce_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function mobler_ecommerce_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->mobler_ecommerce_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function mobler_ecommerce_load( $class ) {
