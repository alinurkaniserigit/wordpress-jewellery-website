...
<?php
 $tiffany_lite_shop_page_sidebar = get_theme_mod( 'tiffany_lite_shop_page_sidebar',true );
 if ( false == $tiffany_lite_shop_page_sidebar ) {
...
<div class="container">
	<main role="main" id="maincontent">
		<div class="row">
			...
			<?php if ( false != $tiffany_lite_shop_page_sidebar ) {?>
