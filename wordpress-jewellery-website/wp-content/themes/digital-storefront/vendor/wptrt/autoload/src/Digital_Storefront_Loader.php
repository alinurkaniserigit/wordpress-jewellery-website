...
class digital_storefront_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function digital_storefront_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function digital_storefront_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function digital_storefront_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function digital_storefront_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->digital_storefront_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function digital_storefront_load( $class ) {
